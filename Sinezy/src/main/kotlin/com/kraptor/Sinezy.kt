...
//        "${mainUrl}/"                    to  "Yeni Eklenenler",
        ...
        "${mainUrl}/izle/animasyon-filmleri/"       to  "Animasyo",
        "${mainUrl}/izle/belgesel-izle/"            to  "Belgese",
        "${mainUrl}/izle/bilim-kurgu-filmleri/"     to  "Bilim Kurgu",
        "${mainUrl}/izle/biyografi-filmleri/"       to  "Biyografi",
        "${mainUrl}/izle/dram-filmleri/"            to  "Dra",
        "${mainUrl}/izle/erotik-film-izle/"         to  "Erotik",
        "${mainUrl}/izle/fantastik-filmler/"        to  "Fantasti",
        "${mainUrl}/izle/gelecek-filmler/"          to  "Yakınd",
        ...
        "${mainUrl}/izle/yabanci-dizi/"             to  "Yabancı Diz",
        "${mainUrl}/izle/en-iyi-filmler/"           to  "En İyi Filmle",
        "${mainUrl}/izle/en-yeni-filmler/"          to  "Yeni Filmle",
        "${mainUrl}/izle/yerli-filmler/"            to  "Yerli Filmle",
